...
object ValidationUtils {
    ...
    // Helper methods
    fun isValidEmail(email: String): Boolean = validateEmail(email).isSuccess
    fun isValidPassword(password: String): Boolean = validatePassword(password).isSuccess
    fun isValidName(name: String): Boolean = validateDisplayName(name).isSuccess
}
